...
<div align="center">
    ...
    <tr> 
      <td align="center">
        <a href="https://enclaive.io/products/arangodb">
  ...
  <h2 align="center">SGX-ready ArangoDB: Multi-Model Database memory-encrypted while in use</h2>
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/enclaive/enclaive-docker-arangodb-sgx/issues">Report Bug</a>
    ·
...
```sh
docker pull enclaive/arangodb-sgx
docker-compose up -d
```
...
<!-- INTRODCUTION -->
## What is ArangoDB and SGX?

ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Build high performance applications using a convenient SQL-like query language or JavaScript extensions.

[Overview of ArangoDB](https://www.arangodb.com)
...
<!-- WHY -->
## Why use ArangoDB-SGX (instead of "vanilla" ArangoDB) images?
Following benefits come for free with ArangoDB-SGX :

- security: ArangoDB-SGX gives data the safest place a database can give going beyond database encryption ("data at rest")
...
- untraceability: when combined with TLS, ArangoDB-SGX keeps the user interacting with the database indistinguishable from any other user interaction even
...
<!-- DEPLOY IN THE CLOUD -->
## How to deploy ArangoDB-SGX in a zero-trust cloud?
...
The recommended way to get the enclaive ArangoDB-SGX Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/enclaive/arangodb-sgx).

```console
docker pull enclaive/arangodb-sgx:latest
```

To use a specific version, you can pull a versioned tag. You can view the
[list of available versions](https://hub.docker.com/r/enclaive/arangodb-sgx/tags/)
in the Docker Hub Registry.

```console
docker pull enclaive/arangodb-sgx:[TAG]
```
...
```console
docker build -t enclaive/arangodb-sgx:latest 'https://github.com/enclaive/enclaive-docker-arangodb-sgx.git#master'
```

<!-- RELEASE NOTES -->
## Release Notes

- application currently breaks on restart due to issues with gramine
- also unstable due to memory issues with javascript and fixed sizes for stack and memory
